...
module Program =
    ...
    let basicSound = API.createSoundWithEnveloppe 440. (Seconds 1) Sin 0.25 0.25 0. 0.25 0.25
    API.writeToWav "basic.wav" [basicSound]

    let primitiveFlanger = Filter.flanger 20. 0.5 44100. basicSound
    API.writeToWav "primitiveFlanger.wav" [primitiveFlanger]
